				...
				<div
					...
					<form class="form-horizontal" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username"
									placeholder="请输入用户名" name="username" value="${remUser}" /> <input
									type="hidden" name="method" value="userLogin" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="${pageContext.request.contextPath}/resources/files/captcha.jhtml" />
							</div>
